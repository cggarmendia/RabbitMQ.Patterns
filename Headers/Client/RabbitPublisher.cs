...
namespace Client
{
    public class RabbitPublisher : IDisposable
    {
        ...
        private const string ExchangeName = "Headers.Sample8.Exchange";
        ...
        public void PublishMessage(string message, Dictionary<string, string> headers)
        {
            ...
            _model.BasicPublish(ExchangeName, "", properties, myMessage);
        }
